...
interface TeamLogoEditorDialogProps {
  open: boolean;
...
export function TeamLogoEditorDialog({
  open,
  sourceDataUrl,
  teamName,
  abbreviation,
  ...
  const previewTeam = useMemo(
    ...
    [teamName, abbreviation, processedDataUrl]
  );
    ...
    <Dialog open={open} onOpenChange={(next) => !next && onCancel()}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Remove the outer background and preview how the crest appears in the app.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Flood-fill from image edges only. Interior dark crest details are kept.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-end gap-4 rounded-md border p-3">
              <div className="text-center space-y-1">
                <TeamBadge team={previewTeam} teamId={teamId} size="md" />
                <p className="text-[10px] text-muted-foreground">List</p>
              </div>
              <div className="text-center space-y-1">
                <TeamBadge team={previewTeam} teamId={teamId} size="lg" />
                <p className="text-[10px] text-muted-foreground">Card</p>
              </div>
              <div className="text-center space-y-1">
                <TeamBadge team={previewTeam} teamId={teamId} size="hero" />
