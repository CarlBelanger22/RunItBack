    ...
    const sortedPlayers = [...playersData].sort((a, b) => {
      ...
      switch (sortField) {
        ...
        case 'FPG':
          ...
          break;
        case 'FDPG':
          aValue = a.gamesPlayed > 0 ? a.totalStats.fouls_drawn / a.gamesPlayed : 0;
          bValue = b.gamesPlayed > 0 ? b.totalStats.fouls_drawn / b.gamesPlayed : 0;
          break;
        case '+/-':
              ...
              <Table>
                <TableHeader className="sticky top-0 bg-background z-10">
                  <TableRow>
                    ...
                    <TableHead className={`cursor-pointer select-none text-center ${sortField === 'FDPG' ? 'bg-muted/50' : ''}`} onClick={() => handleSort('FDPG')}>
                      <div className="flex items-center gap-1 justify-center">
                        FDPG
                        {getSortIcon('FDPG')}
                      </div>
                ...
                <TableBody>
                  {sortedPlayers.map((playerData, index) => {
                    ...
                    const fdpg = playerData.gamesPlayed > 0 ? playerData.totalStats.fouls_drawn / playerData.gamesPlayed : 0;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className={`text-center ${sortField === 'FDPG' ? 'bg-muted/50' : ''}`}>{fdpg.toFixed(1)}</TableCell>
